"""
The + operator doesn’t just add two numbers, it can also “add” two strings! The process of combining two strings is called 
...
In this sample of code, we create two 
Preview: Docs Loading link description
variables
 that hold strings and then concatenate them. But we notice that the result was missing a space between the two, let’s add the space in-between using the same concatenation operator!
...
Preview: Docs Takes in a value that can be converted into a string, and returns a copy of the value in the string datatype.
str() function
. If you’re trying to 
Preview: Docs Loading link description
print()
